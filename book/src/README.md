...
| 8b | 0, 2, 2c, 3, 4, 6, 8 | 並列総和の再現性 / CG と Cholesky / 補間誤差 / \\(L^2\\) 誤差の求積 / 時間積分 / メッシュの所有権 / 章8の前提 |

**章2b と章2c は「章2 の一部」ではない。** 番号は読む位置を表しているだけで、
2b は章2の道具立てをそのまま使う独立した題材、2c は章3の前提として置いてある。
